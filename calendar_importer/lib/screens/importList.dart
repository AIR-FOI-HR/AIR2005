  ...
  void initState() {
    ...
    listOfSources = [
      CalendarSource(
          name: "holidays".tr(),
          url:
              'https://raw.githubusercontent.com/psikac/storage/main/planer1.json'),
      CalendarSource(
          name: "IPI ispitni rokovi obaveznih kolegija 1. semestra",
          url:
              'https://raw.githubusercontent.com/psikac/storage/main/planer2.json')
    ];
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [FlatButton(onPressed: () {}, child: Text("ok").tr())],
          );
        });
  }
}
...
class _ImportListView extends WidgetView<ImportList, _ImportListController> {
  _ImportListView(_ImportListController state, String calendarId)
      : super(state);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[_buildAccountIcon(context)],
      ),
        ...
        itemBuilder: (context, index) {
          return Container(
              ...
              child: ListTile(
                  ...
                  onTap: () {
                    state._handleListItemTap(state.listOfSources[index]);
                  }));
        });
  }
              ...
              Column(
                ...
                children: [
                  Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage:
                            NetworkImage(state._currentUser.photoUrl),
                        maxRadius: 30,
                      )),
                  Text(state._currentUser.displayName,
                      style: new TextStyle(fontSize: 18)),
                  Text(state._currentUser.email,
